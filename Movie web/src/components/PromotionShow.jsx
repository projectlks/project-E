...
export default function PromotionShow({ url }) {
  ...
  return (
    ...
    {  !loading &&  <section className=" scrollbar-thin mb-5 w-full py-4 px-5 overflow-x-auto scrollbar-thin scrollbar-thumb-red-500">
          ...
          {data &&
            ...
            data.results.map((m) => (
              <div
                ...
                onClick={() => navigate(`/detailMovie/${m.id}`)}
              >
                {/* poster */}
                <img
                  src={`https://image.tmdb.org/t/p/w500${m.poster_path}`}
                  alt="poster"
                  className="rounded-md object-contain m-1"
                />
                {/* about */}
                <div className="flex flex-col min-w-[160px] justify-between p-2 px-4">
                  <span>
                    ...
                    <p className="text-[12px]"> Date: {m.release_date}</p>
                  </span>
