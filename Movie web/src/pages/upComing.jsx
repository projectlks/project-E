...
export default function upComing() {
    let { data } = useFetch("http://localhost:3000/movies");
          ...
          data.map((m) => (
            ...
            >
              ...
              <div className="h-full p-1 ">
                <img src={m.poster} alt="poster" className="rounded-md" />
              </div>
              ...
              <div className=" flex flex-col min-w-[160px] justify-between p-2 px-4">
                ...
                <span className="flex  space-x-2 items-center">
                  {/* genre */}
                  <p className="py-[5px] px-[8px] text-[12px] bg-blue-500 rounded-md">
                    {m.genre.slice(0, 1)}
                  </p>
                  {/* rating */}
                  <span className="flex text-[12px] items-center px-[6px] py-[3px] border rounded-md w-auto">
                    <img
                      src={star}
                      alt="hello"
